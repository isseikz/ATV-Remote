package tokyo.isseikuzumaki.signalinglib.demo.viewmodel
...
import tokyo.isseikuzumaki.signalinglib.demo.utils.asDomain
...
class AppViewModel : ViewModel() {
    ...
    fun sendAdbCommand(command: String) = flow {
        ...
        adb.sendAdbCommand(
            ...
            emit(if (result.isSuccess) Result.success(Unit) else Result.failure(Exception(result.output)))
        }.first()
    }
